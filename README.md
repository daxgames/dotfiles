...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/daxgames/ditfiles/main/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/daxgames/ditfiles/main/install.sh`" -s ask
```
